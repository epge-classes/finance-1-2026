...
$$
\frac{P_t}{D_t}=f(\lambda_t),\qquad \frac{\partial f(\lambda_t)}{\partial \lambda_t}<0
$$

- High disaster intensity lowers price-dividend ratios
- Expected returns rise in high-$\lambda_t$ states
- Volatility and predictability move with tail-risk state

## How Wachter Took It to Data

- Calibrate persistence and volatility of $\lambda_t$
...
- TODO: insert disaster-intensity figure from @Wachter2013
- Intended exhibit: high-$\lambda_t$ episodes and valuation compression

\vspace{3.8cm}

## TODO Table: Wachter Quantitative Fit

- TODO: insert benchmark moments table from @Wachter2013
