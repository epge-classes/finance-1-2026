---
title: "Lecture 13: Characteristics, Covariances, and Time-Varying Betas"
date: "2026-03-16"
...
- Part IV (next class): pricing the 25 portfolios is easy like Sunday morning [@LewellenNagelShanken2010]
...
- Important: the only "characteristics" that matter are the betas!
...
- What would @Ross1976 say about this discussion?
...
- @DavisFamaFrench2000 push back against the characteristic story
- Their point: the sample in DT97 (1963-1993) is short and anomalous
- They perform the same analysis as DT97 but with different samples, and get different results
...
- Everything we've talked about so far was about **unconditional** betas and premia
...
- Let's generalize the expected return:
```{=latex}
\begin{gather*}
...
- Question: do they help forecast returns through betas? Or through $\alpha_{i,t}$?
...
Super important line of research during the late 90s and early 2000s:
