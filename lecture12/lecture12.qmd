...
- Step 4: the characteristics-versus-covariances debate [@DanielTitman1997]
...
- Each June, they would compute $\beta$ for each with past data
...
- You get 100 time series of portfolios returns
...
- @DeBondtThaler1985: loosers will be winners, and winners will be losers
...
plt.xlabel("Portfolio (Winner to Looser in 12-months)")
plt.ylim(-0.8,0.4)
...
For any charachteristic $x_{i,t}$, regress $\alpha_{i,t} = a + b x_{i,t} + \varepsilon_{i,t}$
...
- Terrible fund stay terrible, great funds stay great, but everyone else is kind of random
- It still leaves interpretation open: risk compensation or mispricing?

## Contingency Matrix
![](Contingency.png){fig-align="center" width="65%"}

## Key Takeways from Carhart (1997)
- Most mutual funds destroy value, in special the very expensive ones
...
- CAPM tests and everything we did typically uses monthly returns
...
![](EU_Asia.png){fig-align="center" width="80%"}

## Different Timings
![](Slices.png){fig-align="center" width="80%"}

## Intraday
![](Intraday.png){fig-align="center" width="80%"}
