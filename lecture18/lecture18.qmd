...
Define
$$
\varepsilon_{t+1}^{\mathbb{Q}} = \varepsilon_{t+1} + \lambda_t
$$
...
X_{t+1}
=
\underbrace{(\mu-\Sigma\lambda_0)}_{\mu^{\mathbb{Q}}}
+
\underbrace{(\Phi-\Sigma\lambda_1)}_{\Phi^{\mathbb{Q}}}X_t
+
...
2. Forecast $X_{t+1},\ldots,X_{t+n-1}$ under $\mathbb{P}$
